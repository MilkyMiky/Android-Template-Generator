...
sealed class FileType(val fileName: String, val content: String) {
    ...
    class Fragment(fileName: String, filePackage: String, userPackage: String) : FileType(
            "${fileName}Fragment.kt",
            "package $filePackage\n" +
                    "\n" +
                    "import android.os.Bundle\n" +
                    "import android.support.v4.utils.Fragment\n" +
                    "import android.view.LayoutInflater\n" +
                    "import android.view.View\n" +
                    "import android.view.ViewGroup\n" +
                    "import $userPackage.R\n" +
                    "\n" +
                    "class ${fileName}Fragment : Fragment() {\n" +
                    "\n" +
                    "    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {\n" +
                    "        return inflater.inflate(R.layout.fragment_${fileName.toLowerCase()}, container, false)\n" +
                    "    }" +
                    "\n" +
                    "}"
    )

    class Presenter(fileName: String, filePackage: String) : FileType(
            "${fileName}Presenter.kt",
            "package $filePackage\n" +
                    "\n" +
                    "\n" +
                    "class ${fileName}Presenter {\n" +
                    "\n" +
                    "}"
    )

    class View(fileName: String, filePackage: String) : FileType(
            "${fileName}View.kt",
            "package $filePackage\n" +
                    "\n" +
                    "\n" +
                    "interface ${fileName}View {\n" +
                    "\n" +
                    "}"
    )
...
//                    "  }\n" +
    ...
    class Common(packageName: String) : FileType(
            ...
            "package $packageName.common\n" +
                    ...
                    "}\n" +
                    "\n" +
                    "fun View.expandPresetAnimationOut() {\n" +
                    "  this.animate()\n" +
                    "    .scaleX(0f)\n" +
                    "    .alpha(0f)\n" +
                    "    .setDuration(200)\n" +
                    ...
                    "        this@expandPresetAnimationOut.visibility = View.GONE\n" +
                    "      }\n" +
                    "    })\n" +
                    ...
                    "}\n" +
                    "\n" +
                    "fun View.expandPresetsAnimationIn(xPoint: Float, yPoint: Float) {\n" +
                    "  with(this) {\n" +
                    "    pivotX = xPoint\n" +
                    "    pivotY = yPoint\n" +
